...
I enjoy watching baseball ⚾ and chasing good food 🍜  
  ...
  <tr style="height:80px;">
    <td style="width:25%; text-align:center;">
      <div style="display:flex; align-items:center; justify-content:center; height:100%;">
        <b>Dankook University</b>
      </div>
    </td>
    <td style="width:75%; vertical-align:middle;">
      <b>CSOS Lab</b><br>
      <i>Department of AI Convergence, Dankook University</i><br>
  ...
  <tr>
    <td colspan="2" style="padding-left:20px;">
      <ul style="margin-top:4px;">
        <li><b>Position:</b> M.S. Student</li>
...
- Affiliation: CSOS Lab (Advisor: Prof. Seong-je Cho)
- Status: Graduate Student (1st year)

**Dankook University**  
*B.S. in Molecular Biology, Double Major in SW Convergence Contents*
...
## 🌏 Languages
- **Korean** — Native
- **English** — Working proficiency (Bangor University exchange semester; actively practicing speaking)
